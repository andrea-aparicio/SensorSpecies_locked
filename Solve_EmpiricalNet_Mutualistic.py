...
#%% plot to check simulation results
    ...
    plt.plot(Muts1)
    plt.ylim(0,100)
    plt.savefig(fn+"_ts1.png", dpi=300)
    plt.close()
...
#% save data
    ...
    np.savetxt(folderd+fn+"_var1.csv", varM)
    np.savetxt(folderd+fn+"_mean1.csv", meanM)
    np.savetxt(folderd+fn+"_samp1.csv", sampM)
